...
### Grid.ECS.Analyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Grid.ECS.Analyzer.Sample.csproj](../Grid.ECS.Analyzer.Sample/Grid.ECS.Analyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Grid.ECS.Analyzer.Tests
